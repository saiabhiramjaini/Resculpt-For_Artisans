      ...
      children: [
        GestureDetector(
          onTap: () async {
            ...
            wood = false;
            itemStream =
                await DatabaseFunctions().getProductsCategoryWise("Plastic");
            setState(() {});
          },
          child: Material(
            elevation: 5.0,
        ...
        GestureDetector(
          onTap: () async {
            ...
            wood = false;
            itemStream =
                await DatabaseFunctions().getProductsCategoryWise("Glass");
            setState(() {});
          },
          child: Material(
            elevation: 5.0,
        ...
        GestureDetector(
          onTap: () async {
            ...
            wood = false;
            itemStream =
                await DatabaseFunctions().getProductsCategoryWise("Fabric");
            setState(() {});
          },
          child: Material(
            elevation: 5.0,
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Image.asset(
                  ...
                  height: 40,
                  width: 40,
                  color: fabric ? Colors.white : Colors.black,
                ),
              ),
            ),
          ),
        ...
        GestureDetector(
          onTap: () async {
            ...
            wood = true;
            itemStream =
                await DatabaseFunctions().getProductsCategoryWise("Wood");
            setState(() {});
          },
          child: Material(
            elevation: 5.0,
