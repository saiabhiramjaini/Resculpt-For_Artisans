...
import 'package:round2/features/app/screens/requirement_fulfilled_screen.dart';
import 'package:round2/features/auth/signup_screen.dart';
import 'package:round2/features/app/screens/upload_innovations.dart';
        ...
        GestureDetector(
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) {
              return const RequirementFulfilledScreen();
            }));
          },
          child: Container(
            margin: const EdgeInsets.symmetric(horizontal: 20.0),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: 300,
                        child: Text(
                          "Upload your innovative products on to market app",
                          style: TextStyleWidget.semiBoldTextFieldStyle(),
                        ),
                      )
                    ],
